...
const checks = [
  ...
  ['Article cell shows Barcode and Description from Master', ui.includes('data-store-barcode') && ui.includes('data-store-description') && ui.includes("row.querySelector('.siBarcode')") && storeCss.includes('[data-store-description]')],
