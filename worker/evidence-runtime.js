...
const FINAL_UI_STYLE = '<link rel="stylesheet" href="/final-ui.css?v=complete-grid-2">';
const STORE_SUBMIT_STYLE = '<link rel="stylesheet" href="/store-submit.css?v=complete-grid-2">';
const FINAL_UI_SCRIPT = '<script type="module" src="/final-ui.js?v=complete-grid-2"></script>';
